...
<div class="registrasi-form">
    ...
    <?= $form->field($model, 'status')->dropDownList([ 'B' => 'B', 'P' => 'P', ], ['prompt' => '']) ?>
    ...
    <?= $form->field($model, 'status_pendaftaran')->dropDownList([ 'Tidak Lolos' => 'Tidak Lolos', 'Proses' => 'Proses', 'Diterima' => 'Diterima', ], ['prompt' => '']) ?>
