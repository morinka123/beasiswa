...
-- ----------------------------
INSERT INTO `registrasi` VALUES ('40', '51', 'B', '2016', '2015/2016', 'genap', 'Lolos Tahap I');
...
-- ----------------------------
INSERT INTO `riwayat_pendidikan_baru` VALUES ('1', '40', '1', '', '', '', '0.00');
...
-- ----------------------------
INSERT INTO `status_kegiatan_pth` VALUES ('1', '51', '', '', '', '', '0000-00-00', '0000-00-00', 'belum');
INSERT INTO `status_kegiatan_pth` VALUES ('2', '51', '', '', '', '', '0000-00-00', '0000-00-00', 'belum');
INSERT INTO `status_kegiatan_pth` VALUES ('3', '51', '', '', '', '', '0000-00-00', '0000-00-00', 'belum');

-- ----------------------------
-- Table structure for `status_transfer_pth`
-- ----------------------------
DROP TABLE IF EXISTS `status_transfer_pth`;
CREATE TABLE `status_transfer_pth` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `user_id` int(4) DEFAULT NULL,
  `no_rek` varchar(20) DEFAULT NULL,
  `kategori` int(4) DEFAULT NULL,
  `nominal` decimal(14,2) DEFAULT NULL,
  `tgl_transfer` date DEFAULT NULL,
  `status_kegiatan` enum('belum','sudah') DEFAULT NULL,
  `tgl_pengembalian` date DEFAULT NULL,
  `status_transfer` enum('belum','sudah') DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `status_transfer_pth_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of status_transfer_pth
-- ----------------------------
INSERT INTO `status_transfer_pth` VALUES ('1', '51', null, null, '0.00', null, null, null, null);
...
CREATE TABLE `user` (
  ...
  `status_kawin` enum('Belum','Sudah') DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('33', null, 'admin@admin.com', '12345', null, null, null, null, null, '1970-01-01', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '1', '5555555', null, null, null, null, null);
INSERT INTO `user` VALUES ('51', '1', 'morinka123@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '', '', '', null, '', null, '', '', '', null, '', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'b1dbe43cf6edfc567c3d668ed71985fd', '1');
